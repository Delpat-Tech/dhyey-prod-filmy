                ...
                <div className="flex items-center space-x-4 flex-1">
                  ...
                  <div className="hidden md:flex items-center space-x-6 text-sm text-gray-500">
                    <div className="text-center">
                      <div className="font-medium text-gray-900">{user.stats?.storiesCount || user.stats?.stories || 0}</div>
                      <div>Stories</div>
                    </div>
                    <div className="text-center">
                      <div className="font-medium text-gray-900">{user.stats?.followersCount || user.stats?.followers || 0}</div>
                      <div>Followers</div>
                    </div>
                  </div>
